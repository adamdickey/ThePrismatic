...
public class ScryDiscardsPatch {
    ...
    public static void Insert() {
        for(AbstractCard c : AbstractDungeon.gridSelectScreen.selectedCards){
            ...
            if(c instanceof DeadlyPoison2 || c instanceof Reflex2 || c instanceof Tactician2 || c instanceof Weave2 || c instanceof Vigilance2 || c instanceof Eruption2 || c instanceof Sentinel2){
