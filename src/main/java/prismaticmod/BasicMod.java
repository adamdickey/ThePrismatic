    ...
    public void receiveEditRelics()
    {
        ...
        new AutoAdd(modID)
                ...
                .any(CustomRelic.class, (info, relic) -> {
                    ...
                    BaseMod.addRelicToCustomPool(relic, AbstractCard.CardColor.RED);
                    BaseMod.addRelicToCustomPool(relic, AbstractCard.CardColor.GREEN);
                    BaseMod.addRelicToCustomPool(relic, AbstractCard.CardColor.BLUE);
                    BaseMod.addRelicToCustomPool(relic, AbstractCard.CardColor.PURPLE);
                    if (info.seen) {
