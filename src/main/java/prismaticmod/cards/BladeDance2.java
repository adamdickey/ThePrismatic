...
public class BladeDance2 extends BaseCard {
    public static final String ID = makeID("Blade Dance"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final int shivNumber = 3;
    private static final int UPG_shiv = 1;
