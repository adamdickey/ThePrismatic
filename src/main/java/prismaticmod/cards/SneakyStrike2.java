...
public class SneakyStrike2 extends BaseCard {
    public static final String ID = makeID("Sneaky Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
