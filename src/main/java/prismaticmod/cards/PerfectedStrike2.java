...
public class PerfectedStrike2 extends BaseCard {
    public static final String ID = makeID("Perfected Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
