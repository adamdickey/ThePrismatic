...
public class ChimeraForm extends BaseCard {
    public static final String ID = makeID("Chimera Form"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
