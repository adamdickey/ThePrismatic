...
import prismaticmod.powers.CombustivePower;
import prismaticmod.util.CardStats;
import theprismatic.ThePrismatic;

public class CombustiveFumes extends BaseCard {
    public static final String ID = makeID("Combustive Fumes"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
