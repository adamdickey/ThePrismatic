...
public class ScryingStrike extends BaseCard {
    public static final String ID = makeID("Scrying Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
