...
public class EvolvedFirebreathing extends BaseCard {
    public static final String ID = makeID("Evolved Firebreathing"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
