...
public class WraithForm2 extends BaseCard {
    public static final String ID = makeID("Wraith Form"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
