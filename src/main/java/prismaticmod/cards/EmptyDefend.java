...
public class EmptyDefend extends BaseCard {
    public static final String ID = makeID("Empty Defend"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
