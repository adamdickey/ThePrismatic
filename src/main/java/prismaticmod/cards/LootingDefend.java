...
public class LootingDefend extends BaseCard {
    public static final String ID = makeID("Looting Defend"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
