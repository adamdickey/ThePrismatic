...
public class CombatTraining extends BaseCard {
    public static final String ID = makeID("Combat Training"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
