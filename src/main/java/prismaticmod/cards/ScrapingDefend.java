...
public class ScrapingDefend extends BaseCard {
    public static final String ID = makeID("Scraping Defend"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
