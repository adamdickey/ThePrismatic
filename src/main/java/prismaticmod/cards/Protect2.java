...
public class Protect2 extends BaseCard {
    public static final String ID = makeID("Protect"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final int baseBlock = 12;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new RetainThisTurn(magicNumber), magicNumber));
    }
}
