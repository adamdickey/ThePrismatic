...
public class QuickSlash2 extends BaseCard {
    public static final String ID = makeID("Quick Slash"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
