...
public class ScrapingStrike extends BaseCard {
    public static final String ID = makeID("Scraping Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
