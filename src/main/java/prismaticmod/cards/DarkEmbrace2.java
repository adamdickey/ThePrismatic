...
public class DarkEmbrace2 extends BaseCard {
    public static final String ID = makeID("Dark Embrace"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
