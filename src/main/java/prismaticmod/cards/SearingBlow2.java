...
public class SearingBlow2 extends BaseCard {
    public static final String ID = makeID("Searing Blow"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public SearingBlow2(int upgrades) {
        super(ID, info);
        this.baseDamage = 16;
