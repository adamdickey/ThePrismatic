...
public class Reprogram2 extends BaseCard {
    public static final String ID = makeID("Reprogram"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
