...
public class ToxicDefend extends BaseCard {
    public static final String ID = makeID("Toxic Defend"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
