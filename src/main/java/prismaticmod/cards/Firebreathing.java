...
public class Firebreathing extends BaseCard {
    public static final String ID = makeID("Firebreathing"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
