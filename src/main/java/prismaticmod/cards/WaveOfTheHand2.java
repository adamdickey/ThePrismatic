...
public class WaveOfTheHand2 extends BaseCard {
    public static final String ID = makeID("Wave of the Hand"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
