...
public class LootingStrike extends BaseCard {
    public static final String ID = makeID("Looting Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
