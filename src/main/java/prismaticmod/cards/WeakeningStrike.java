...
public class WeakeningStrike extends BaseCard {
    public static final String ID = makeID("Weakening Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
