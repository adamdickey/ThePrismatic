...
public class StormOfSteel2 extends BaseCard {
    public static final String ID = makeID("Storm of Steel"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
