...
public class OchoForm extends BaseCard {
    public static final String ID = makeID("0ch0 Form"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
