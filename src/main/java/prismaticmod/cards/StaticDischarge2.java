...
public class StaticDischarge2 extends BaseCard {
    public static final String ID = makeID("Static Discharge"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
