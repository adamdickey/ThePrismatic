...
public class HitAndRun extends BaseCard {
    public static final String ID = makeID("Hit and Run"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(!m.hasPower(ArtifactPower.POWER_ID) && !m.hasPower(WeakPower.POWER_ID)){
            addToBot(new GainBlockAction(p, p, block, true));
        }
    }
}
