...
public class EmptyStrike extends BaseCard {
    public static final String ID = makeID("Empty Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
