...
public class CunningStrike extends BaseCard {
    public static final String ID = makeID("Cunning Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
