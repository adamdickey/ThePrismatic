...
public class DoubleTap2 extends BaseCard {
    public static final String ID = makeID("Double Tap"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
