...
public class FireBreathing2 extends BaseCard {
    public static final String ID = makeID("Fire Breathing"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
