...
public class CompileDriver2 extends BaseCard {
    public static final String ID = makeID("Compile Driver"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (orbNum > 0) {
            addToBot(new DrawCardAction(orbNum));
        }
    }
}
