...
public class TinyHouse2 extends BaseRelic {
    private static final String NAME = "Tiny House"; //The name will be used for determining the image file as well as the ID.
